<?php if (!defined('NEWGUARD'))			exit('Нет доступа'); // websun 0.1.48
...
Class tpl 
{
    ...
    public function changeDesc($str) 
	{
	...
	private $predecessor = false; // объект шаблонизатора верхнего уровня, из которого делался вызов текущего
	
	function __construct() 
	{
		$this->templates_root_dir = $_SERVER['DOCUMENT_ROOT'].'/tpl';
		$this->templates_current_dir = $this->templates_root_dir . '/';
	}
	
	function parse($template_path,$vars) 
	{
		$this->vars = $vars;
