...
$confirmationToken = '6ef9d025';

//Ключ доступа сообщества
$token = '66697a12be59a38212ea4719ce66fb9dbca3313a3488736ad46e492762ac45935c4d6e97ddbf93ff74dbf';

// Secret key
$secretKey = 'testapi170198';
...
switch ($data->type) {
    ...
    case 'group_join':
        ...
        //затем с помощью users.get получаем данные об авторе
        $userInfo = json_decode(file_get_contents("https://api.vk.com/method/users.get?user_ids={$userId}&v=5.90"));
